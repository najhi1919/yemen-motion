...
class CreateWorksCategoryRequest extends FormRequest
{
    /** @var list<string> */
    ...
    {
        return $this->authorizedFor('admin.works.taxonomy.categories.create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => [
                ...
                'lowercase',
                'regex:/^[a-z0-9]+(?:-[a-z0-9]+)*$/',
                Rule::unique('work_categories', 'slug'),
            ],
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            foreach (array_keys($this->query->all()) as $parameter) {
                $validator->errors()->add((string) $parameter, 'معاملات الاستعلام غير مدعومة لإنشاء تصنيف الأعمال.');
            }
            ...
            foreach ($unexpectedFields as $field) {
                $validator->errors()->add((string) $field, 'حقل الطلب غير مدعوم لإنشاء تصنيف الأعمال.');
            }
        });
    }
