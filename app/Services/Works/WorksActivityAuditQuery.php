...
class WorksActivityAuditQuery
{
    ...
    private const EVENT_DEFINITIONS = [
        ...
        'works.designer.archived' => [
            'event_type' => 'works.designer.archived',
            'event_group' => 'lifecycle',
            'group_label_ar' => 'دورة حياة العمل',
            'group_label_en' => 'Work lifecycle',
            'event_key' => 'designer_archived',
            'label_ar' => 'أرشفة العمل بواسطة المصمم',
            'label_en' => 'Work archived by designer',
            'target_scope' => 'work',
            'requires_work' => true,
            'needs_attention' => false,
            'severity_fallback' => 'notice',
        ...
        'works.designer.restored' => [
            'event_type' => 'works.designer.restored',
            'event_group' => 'lifecycle',
            'event_key' => 'designer_restored',
            'label_ar' => 'استعادة العمل بواسطة المصمم',
            'label_en' => 'Work restored by designer',
            'target_scope' => 'work',
            'requires_work' => true,
            'needs_attention' => false,
            'severity_fallback' => 'notice',
