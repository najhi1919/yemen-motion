  ...
  <section class="ym-settings-editor" aria-labelledby="ym-settings-editor-title">
    <header class="ym-settings-editor__head">
      <div>
        ...
        <span>مهلة المراجعة مطبقة على قائمة المراجعة، وثقة النشر المباشر مطبقة على نتيجة الاعتماد، وحدود الوسائط مطبقة على Media Upload API الإداري. واجهة التأليف الرسومية وإدارة ترتيب الوسائط والغلاف ما تزال لاحقة.</span>
      </div>
    ...
    <div class="ym-settings-editor__cards">
      ...
      <article class="ym-settings-editor-card is-media" :aria-disabled="!canEditMedia">
        ...
        <p class="ym-settings-editor-card__note is-warning">
          هذه الحدود مطبقة على Media Upload API الإداري، بينما واجهة التأليف الرسومية وإدارة ترتيب الوسائط والغلاف ما تزال لاحقة.
        </p>
      </article>
    </div>
