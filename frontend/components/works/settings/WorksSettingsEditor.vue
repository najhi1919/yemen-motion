  ...
  <section class="ym-settings-editor" aria-labelledby="ym-settings-editor-title">
    <header class="ym-settings-editor__head">
      <div>
        ...
        <span>مهلة المراجعة وثقة النشر المباشر مطبقتان، وحدود الوسائط مطبقة على الرفع الإداري، كما يتوفر ترتيب الوسائط واختيار الغلاف عبر API الإداري. واجهة التأليف الرسومية والإرسال للمراجعة ما يزالان لاحقين.</span>
      </div>
    ...
    <div class="ym-settings-editor__cards">
      ...
      <article class="ym-settings-editor-card is-media" :aria-disabled="!canEditMedia">
        ...
        <p class="ym-settings-editor-card__note is-warning">
          حدود الوسائط مطبقة على الرفع الإداري، ويتوفر ترتيب الوسائط واختيار الغلاف عبر API الإداري، بينما واجهة التأليف الرسومية والإرسال للمراجعة ما يزالان لاحقين.
        </p>
      </article>
    </div>
