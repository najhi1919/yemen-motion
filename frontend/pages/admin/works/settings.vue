    ...
    <template v-else>
      <section class="ym-works-settings-notices" aria-label="ملاحظات إعدادات الأعمال">
        ...
        <aside class="ym-works-settings-notice is-restriction" role="note">
          ...
          <p>مهلة المراجعة مطبقة على قائمة المراجعة، وثقة النشر المباشر مطبقة على نتيجة اعتماد العمل، وحدود الوسائط مطبقة على Media Upload API الإداري. واجهة التأليف الرسومية وإدارة ترتيب الوسائط والغلاف ما تزال لاحقة.</p>
        </aside>
      </section>
