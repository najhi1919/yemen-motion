    ...
    <template v-else>
      <section class="ym-works-settings-notices" aria-label="ملاحظات إعدادات الأعمال">
        ...
        <aside class="ym-works-settings-notice is-restriction" role="note">
          ...
          <p>مهلة المراجعة وثقة النشر المباشر مطبقتان، وحدود الوسائط مطبقة على الرفع الإداري، كما يتوفر ترتيب الوسائط واختيار الغلاف عبر API الإداري. واجهة التأليف الرسومية والإرسال للمراجعة ما يزالان لاحقين.</p>
        </aside>
      </section>
