...
const dictionary = {
  ar: {
    badge: 'قيد التجهيز',
    fallbackTitle: 'صفحة فريق العمل غير مكتملة',
    message: 'هذه الصفحة موجودة ضمن خطة لوحة فريق العمل، لكنها لم تُبن بعد. سيتم تجهيزها في مرحلة لاحقة.'
  },
  en: {
    badge: 'In progress',
    fallbackTitle: 'Staff page under construction',
    message: 'This staff page is planned, but it has not been built yet. It will be completed in a later phase.'
  }
}
...
.ym-placeholder-card {
  ...
  border-radius: 30px;
  background:
    radial-gradient(circle at 20% 0%, color-mix(in srgb, #22c55e 16%, transparent), transparent 18rem),
    var(--ym-card-bg);
