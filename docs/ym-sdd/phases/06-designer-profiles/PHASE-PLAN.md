...
| E. Organization/Brand Data | بيانات المنشأة أوالعلامة عند انطباقها | `closed`؛ محطة `008A`، Closure Commit `1ec3a88` |
...
| 4 | `YM-DESIGNER-PROFILE-ORGANIZATION-BRAND-008A` | `closed`؛ `1ec3a88` | إغلاق `007A` |
