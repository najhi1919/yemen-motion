...
| B. Publication Lifecycle | شروط الجاهزية، معاينة الزائر، النشر، الإخفاء أوإلغاء النشر، الرسائل والتدقيق | `planned` |
| C. Public Profile | الصفحة العامة `/designers/{username}`، البيانات العامة، الحالات العامة، SEO | `planned` |
...
| 2 | `YM-DESIGNER-PUBLIC-PROFILE-006A` | `planned` | إغلاق `005A` |
