...
| 8. Organization Data | بيانات المنشأة أوالعلامة عند انطباقها | `not-met` | محطة 008A معتمدة للتنفيذ. |
